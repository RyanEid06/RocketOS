...
export type AppCategory = 'system' | 'developer' | 'productivity' | 'graphics' | 'utilities' | 'media';
...
export class AppRegistry {
  private static readonly APPS: Record<AppId, AppDefinition> = {
    ...
    profiler: {
      id: 'profiler',
      displayName: 'Flamegraph Profiler',
      description: 'Call-stack flamegraph, microbenchmarks, and thread-confined ARC memory profiler',
      glyph: '🔥',
      category: 'developer',
      isSingleton: true,
      constraints: { defaultWidth: 880, defaultHeight: 560, minWidth: 580, minHeight: 380 },
      supportedExtensions: ['.prof', '.trace'],
      keywords: ['profiler', 'flamegraph', 'benchmark', 'cpu', 'memory', 'arc', 'performance', 'latency'],
      isSystemApp: false,
    },
    disassembler: {
      id: 'disassembler',
      displayName: 'LLVM IR & Disassembler',
      description: 'Inspect LLVM 22.1.6 IR, x86_64 assembly, and ABI v1 register conventions',
      glyph: '🧬',
      category: 'developer',
      isSingleton: false,
      constraints: { defaultWidth: 880, defaultHeight: 560, minWidth: 580, minHeight: 380 },
      supportedExtensions: ['.ll', '.s', '.asm'],
      keywords: ['disassembler', 'asm', 'assembly', 'llvm', 'ir', 'bytecode', 'registers', 'abi'],
      isSystemApp: false,
    },
    cheatsheet: {
      id: 'cheatsheet',
      displayName: 'Rocket Language Manual',
      description: 'Authoritative Rocket 2.1 syntax, stdlib reference, and interactive cheatsheet',
      glyph: '📖',
      category: 'developer',
      isSingleton: true,
      constraints: { defaultWidth: 860, defaultHeight: 560, minWidth: 560, minHeight: 380 },
      supportedExtensions: [],
      keywords: ['cheatsheet', 'manual', 'docs', 'syntax', 'stdlib', 'reference', 'grammar', 'rocket'],
      isSystemApp: false,
    },
    wifi: {
      id: 'wifi',
      displayName: 'Wi-Fi & Wireless Control',
      description: 'Scan Wi-Fi 7 networks, MLO bands, configure static/DHCP IP, hotspot and speedtest',
      glyph: '📶',
      category: 'utilities',
      isSingleton: true,
      constraints: { defaultWidth: 860, defaultHeight: 560, minWidth: 540, minHeight: 380 },
      supportedExtensions: [],
      keywords: ['wifi', 'wireless', 'network', 'ssid', 'hotspot', 'speedtest', 'wpa3', 'internet'],
      isSystemApp: true,
    },
    bluetooth: {
      id: 'bluetooth',
      displayName: 'Bluetooth & Device Hub',
      description: 'Pair peripherals, wireless audio, BLE sensors, and OBEX file beam',
      glyph: 'ᛒ',
      category: 'utilities',
      isSingleton: true,
      constraints: { defaultWidth: 860, defaultHeight: 560, minWidth: 540, minHeight: 380 },
      supportedExtensions: [],
      keywords: ['bluetooth', 'ble', 'pair', 'headphones', 'keyboard', 'mouse', 'wireless'],
      isSystemApp: true,
    },
    'device-manager': {
      id: 'device-manager',
      displayName: 'Device Manager & Drivers',
      description: 'Hardware hierarchy tree, PCIe/USB bus scan, driver updates, and diagnostic self-test',
      glyph: '⚙️',
      category: 'system',
      isSingleton: true,
      constraints: { defaultWidth: 900, defaultHeight: 600, minWidth: 560, minHeight: 400 },
      supportedExtensions: ['.inf', '.sys'],
      keywords: ['device', 'manager', 'driver', 'hardware', 'pcie', 'cpu', 'gpu', 'irq', 'diagnostics'],
      isSystemApp: true,
    },
    calendar: {
      id: 'calendar',
      displayName: 'Calendar & Scheduler',
      description: 'System event scheduler, agenda planner, and reminders',
      glyph: '📅',
      category: 'productivity',
      isSingleton: true,
      constraints: { defaultWidth: 900, defaultHeight: 580, minWidth: 600, minHeight: 400 },
      supportedExtensions: ['.ics'],
      keywords: ['calendar', 'events', 'schedule', 'agenda', 'reminders', 'date', 'meetings'],
      isSystemApp: true,
    },
    mail: {
      id: 'mail',
      displayName: 'Rocket Mail',
      description: 'Local and remote mailbox daemon, message viewer, and composer',
      glyph: '✉️',
      category: 'productivity',
      isSingleton: true,
      constraints: { defaultWidth: 960, defaultHeight: 620, minWidth: 640, minHeight: 440 },
      supportedExtensions: ['.eml', '.msg'],
      keywords: ['mail', 'email', 'inbox', 'messages', 'spool', 'rmaild'],
      isSystemApp: true,
    },
    'software-center': {
      id: 'software-center',
      displayName: 'Software Center',
      description: 'Curated repository browser, app store, and rockpm package installer',
      glyph: '🛍️',
      category: 'utilities',
      isSingleton: true,
      constraints: { defaultWidth: 980, defaultHeight: 640, minWidth: 680, minHeight: 460 },
      supportedExtensions: ['.rpkg', '.tar.gz'],
      keywords: ['software', 'store', 'packages', 'install', 'rockpm', 'apps'],
      isSystemApp: true,
    },
    recorder: {
      id: 'recorder',
      displayName: 'Sound Recorder & Studio',
      description: 'High-fidelity audio recording, live oscilloscope, and WAV export',
      glyph: '🎙️',
      category: 'media',
      isSingleton: true,
      constraints: { defaultWidth: 720, defaultHeight: 560, minWidth: 500, minHeight: 400 },
      supportedExtensions: ['.wav', '.ogg', '.flac'],
      keywords: ['sound', 'recorder', 'microphone', 'voice', 'audio', 'waveform'],
      isSystemApp: true,
    },
    firewall: {
      id: 'firewall',
      displayName: 'Firewall & Security Guard',
      description: 'Kernel packet filter, port routing rules, and socket inspector',
      glyph: '🛡️',
      category: 'system',
      isSingleton: true,
      constraints: { defaultWidth: 900, defaultHeight: 600, minWidth: 600, minHeight: 420 },
      supportedExtensions: ['.rules', '.conf'],
      keywords: ['firewall', 'security', 'ports', 'netfilter', 'sockets', 'ddos'],
      isSystemApp: true,
    },
    benchmark: {
      id: 'benchmark',
      displayName: 'System Benchmark',
      description: 'Measure ARC promotion throughput, LLVM SIMD, and VFS IOPS performance',
      glyph: '⚡',
      category: 'system',
      isSingleton: true,
      constraints: { defaultWidth: 860, defaultHeight: 580, minWidth: 560, minHeight: 400 },
      supportedExtensions: ['.bench'],
      keywords: ['benchmark', 'performance', 'speed', 'llvm', 'cpu', 'score', 'stress'],
      isSystemApp: true,
    },
  };
