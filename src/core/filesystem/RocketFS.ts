...
export class RocketFS {
  ...
  public bootstrapDefaultHierarchy(): void {
    ...
    // Clean starter file placed safely in Documents (keeps Desktop surface clean)
    const defaultWelcomeContent = '# Welcome to RocketOS 2.1\n\nfn main() -> Int:\n    print("Hello from RocketOS 2.1!")\n    return 0\n';

    this.createRawInode('/Documents/welcome.rocket', 'file', 1000, 100, 0o644, undefined, 'text/x-rocket', defaultWelcomeContent);
    this.createRawInode('/home/ryan/Documents/welcome.rocket', 'file', 1000, 100, 0o644, undefined, 'text/x-rocket', defaultWelcomeContent);
